...
const highlights = [
  ...
  },
  {
    ...
    body: "Watch decisions, blockers, and memory matches assemble in real time as capture chunks are processed.",
  },
  {
  ...
  return (
    <ThemeWrapper theme="ink">
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-16 px-6 py-20 sm:px-10 lg:py-28">
