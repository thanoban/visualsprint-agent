"""Deterministic transcript pipeline for local VisualSprint development."""
...
from visualsprint_api.models import CaptureChunkSummary, TranscriptSegment
...
def build_transcript_segments(chunk: CaptureChunkSummary) -> list[TranscriptSegment]:
